...
export default function ProfileImageModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center z-60">
      <div className="absolute inset-0 bg-black opacity-50" onClick={onClose} />

      <div
        className="relative bg-white rounded-lg p-6 w-[90vw] max-w-md max-h-[90vh] overflow-auto"
        onDragOver={(e) => {
          e.preventDefault();
          setIsDragging(true);
        }}
